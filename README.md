...
We aim for every commit in the Mellifera repository to be complete and
self-contained. Before submitting a pull request, please rebase and squash your
commits into logical units of change. For any non-trivial update, your commit
messages should contain information about *what* the commit does as well as
